...
import static com.lh.remoting.transport.netty.server.NettyRpcServer.PORT;
...
public class SocketRpcServer {
    ...
    public void registerService(Object service) { serviceProvider.publishService(service);}
