package com.lh.utils.concurrent.threadpool;
...
public final class ThreadPoolFactoryUtil {
    ...
    public static ExecutorService createCustomThreadPoolIfAbsent(String threadNamePrefix ){
        ...
        ExecutorService threadPool = THREAD_POOLS.computeIfAbsent(threadNamePrefix, k -> creatThreadPool(customThreadPoolConfig, threadNamePrefix, daemon));
    ...
    private static ExecutorService creatThreadPool(CustomThreadPoolConfig customThreadPoolConfig, String threadNamePrefix, Boolean daemon){
        final ThreadFactory threadFactory = createThreadFactory(threadNamePrefix, daemon);
